...
//
// Other verification functions (`Verify*`) are left for modularity, in case you want to be
// explicit about the typing in your code. However, in the large majority of the cases,
// you only want to call [Verify].
...
func VerifyEntity(
	...
	if !((that.EntityType() == aastypes.EntityTypeSelfManagedEntity &&
		(((that.GlobalAssetID() != nil) &&
			(that.SpecificAssetIDs() == nil)) ||
			((that.GlobalAssetID() == nil) &&
				(that.SpecificAssetIDs() != nil) &&
